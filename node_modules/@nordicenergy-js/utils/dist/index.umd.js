...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bn.js')) :
        ...
        (factory((global.nordicenergyUtils = {}), global.bn.js));
}(this, (function(exports, BN) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var Unit = /** @class */ (function() {
        ...
        Unit.prototype.asNet = function() {
            this.wei = toWei(this.unit, "Net" /* Net */ );
            return this;
        };
        ...
        Unit.prototype.tNett = function() {
            if (this.wei) {
                return fromWei(this.wei, "net" /* Net */ );
            } else {
                throw new Error('error transforming');
            }
        };
    ...
    (function(ChainID) {
        ...
        ChainID[ChainID["NgyMainnet"] = 1] = "NgyMainnet";
        ChainID[ChainID["NgyTestnet"] = 2] = "NgyTestnet";
        ChainID[ChainID["NgyLocal"] = 2] = "NgyLocal";
        ChainID[ChainID["NgyPangaea"] = 3] = "NgyPangaea";
    })(exports.ChainID || (exports.ChainID = {}));
    var defaultConfig = {
        Default: {
            Chain_ID: 2 /* NgyLocal */ ,
            Chain_Type: "ngy" /* NordicEnergy */ ,
    ...
    var NordicEnergyCore = /** @class */ (function() {
        function NordicEnergyCore(chainType, chainId) {
            if (chainId === void 0) { chainId = defaultConfig.Default.Chain_ID; }
            this.chainType = chainType;
            this.chainId = chainId;
        }
        Object.defineProperty(NordicEnergyCore.prototype, "chainPrefix", {
            get: function() {
        ...
        Object.defineProperty(NordicEnergyCore.prototype, "getChainId", {
            get: function() {
                return this.chainId;
            },
            enumerable: true,
        ...
        NordicEnergyCore.prototype.setChainId = function(chainId) {
            this.chainId = chainId;
        };
        NordicEnergyCore.prototype.setChainType = function(chainType) {
            this.chainType = chainType;
        };
        return NordicEnergyCore;
    }());
    ...
    exports.NordicEnergyCore = NordicEnergyCore;
