...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nordicenergy-js/crypto'), require('@nordicenergy-js/transaction'), require('@nordicenergy-js/utils'), require('text-encoding')) :
        typeof define === 'function' && define.amd ? define(['exports', '@nordicenergy-js/crypto', '@nordicenergy-js/transaction', '@nordicenergy-js/utils', 'text-encoding'], factory) :
        (factory((global.nordicenergyStaking = {}), global['@nordicenergy-js/crypto'], global['@nordicenergy-js/transaction'], global['@nordicenergy-js/utils'], global['text-encoding']));
}(this, (function(exports, crypto, transaction, utils, textEncoding) {
    'use strict';
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/ , this.messenger.send("ngy_sendRawStakingTransaction" /* SendRawStakingTransaction */ , this.rawTransaction, this.messenger.chainType, this.messenger.currentShard)];
                        case 1:
                            res = _a.sent();
                            if (res.isResult()) {
                                this.id = res.result;
