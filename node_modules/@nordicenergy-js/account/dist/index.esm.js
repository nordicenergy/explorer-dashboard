...
import { HttpProvider, Messenger, WSProvider } from '@nordicenergy-js/network';
import { generatePrivateKey, getAddressFromPrivateKey, getPubkeyFromPrivateKey, encrypt, decrypt, getAddress, bip39, hdkey } from '@nordicenergy-js/crypto';
import { isPrivateKey, add0xToString, hexToNumber, AddressSuffix, isAddress, HDPath, isHttp, isWs, Unit, isHex } from '@nordicenergy-js/utils';
import { RLPSign, Transaction } from '@nordicenergy-js/transaction';
...
var defaultMessenger = new Messenger(new HttpProvider('http://localhost:9500'), "ngy" /* NordicEnergy */ , 2 /* NgyLocal */ );
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (shardBalanceObject !== undefined) {
                            ...
                            transaction.setParams(__assign(__assign({}, transaction.txParams), {
...
var HDNode = /** @class */ (function() {
    function HDNode(provider, menmonic, index, addressCount, shardID, chainType, chainId, gasLimit, gasPrice) {
        ...
        this.addresses = [];
        this.wallets = {};
        this.path = chainType === "ngy" /* NordicEnergy */ ? HDPath : "m/44'/60'/0'/0/";
        this.index = index;
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        tx = new Transaction(__assign(__assign({}, txParams), {
                            from: from,
                            to: to,
                            gasLimit: gasLimit,
                            gasPrice: gasPrice,
