...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nordicenergy-js/network'), require('@nordicenergy-js/crypto'), require('@nordicenergy-js/utils'), require('@nordicenergy-js/transaction')) :
        typeof define === 'function' && define.amd ? define(['exports', '@nordicenergy-js/network', '@nordicenergy-js/crypto', '@nordicenergy-js/utils', '@nordicenergy-js/transaction'], factory) :
        (factory((global.nordicenergyAccount = {}), global['@nordicenergy-js/network'], global['@nordicenergy-js/crypto'], global['@nordicenergy-js/utils'], global['@nordicenergy-js/transaction']));
}(this, (function(exports, network, crypto, utils, transaction) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var defaultMessenger = new network.Messenger(new network.HttpProvider('http://localhost:9500'), "ngy" /* NordicEnergy */ , 2 /* NgyLocal */ );
    ...
    var Account = /** @class */ (function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/ , this.messenger.send("ngy_getBalance" /* GetBalance */ , [this.address, blockNumber], this.messenger.chainPrefix, this.messenger.currentShard || 0)];
                        case 1:
                            balance = _a.sent();
                            return [4 /*yield*/ , this.messenger.send("ngy_getTransactionCount" /* GetTransactionCount */ , [this.address, blockNumber], this.messenger.chainPrefix, this.messenger.currentShard || 0)];
                        case 2:
                            nonce = _a.sent();
                            if (balance.isError()) {
                ...
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _c.label = 2;
                        case 2:
                            if (!!shardProviders_1_1.dNet) return [3 /*break*/ , 6];
                        ...
                        case 8:
                            try {
                                if (shardProviders_1_1 && !shardProviders_1_1.dNet && (_b = shardProviders_1.return)) _b.call(shardProviders_1);
                            } finally { if (e_1) throw e_1.error; }
                            return [7 /*endfinally*/ ];
                        case 9:
                            return [3 /*break*/ , 12];
                        case 10:
                            return [4 /*yield*/ , this.getShardBalance(this.messenger.currentShard || 0, blockNumber)];
                        case 11:
                    ...
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (shardBalanceObject !== undefined) {
                                ...
                                transaction$$1.setParams(__assign(__assign({}, transaction$$1.txParams), {
                                    from: this.messenger.chainPrefix === "ngy" /* NordicEnergy */ ?
                                        this.bech32Address : this.checksumAddress || '0x',
                                    nonce: shardNonce
                                }));
                            } else {
                                transaction$$1.setParams(__assign(__assign({}, transaction$$1.txParams), {
                            ...
                            if (encodeMode === 'rlp') {
                                ...
                                return [2 /*return*/ , transaction$$1.map(function(obj) {
                                    return __assign(__assign({}, obj), {
                                        ...
                                        from: _this.messenger.chainPrefix === "ngy" /* NordicEnergy */ ?
                                            _this.bech32Address : _this.checksumAddress || '0x'
                                    });
                                })];
                            } else {
                ...
                return __generator(this, function(_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (shardBalanceObject !== undefined) {
                                shardNonce = shardBalanceObject.nonce;
                                staking.setFromAddress(this.messenger.chainPrefix === "ngy" /* NordicEnergy */ ?
                                    this.bech32Address :
        ...
        Account.prototype.getAddresses = function() {
            ...
            var addressArray = [];
            try {
                for (var _b = __values(this.shards), _c = _b.next(); !_c.dNet; _c = _b.next()) {
        ...
        Account.prototype.getShardBalance = function(shardID, blockNumber) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("ngy_getBalance" /* GetBalance */ , [this.address, blockNumber], this.messenger.chainPrefix, shardID)];
                        case 1:
                            balance = _a.sent();
                            return [4 /*yield*/ , this.messenger.send("ngy_getTransactionCount" /* GetTransactionCount */ , [this.address, blockNumber], this.messenger.chainPrefix, shardID)];
                        case 2:
                            nonce = _a.sent();
                            if (balance.isError()) {
                                throw balance.error.message;
    ...
    var Wallet = /** @class */ (function() {
        ...
        Wallet.prototype.addByMnemonic = function(phrase, index) {
            ...
            // TODO:hdkey should apply to NordicEnergy's settings
            var path = this.messenger.chainType === "ngy" /* NordicEnergy */ ? '1023' : '60';
    ...
    var HDNode = /** @class */ (function() {
        function HDNode(provider, menmonic, index, addressCount, shardID, chainType, chainId, gasLimit, gasPrice) {
            ...
            if (chainType === void 0) { chainType = "ngy" /* NordicEnergy */ ; }
            ...
            this.addresses = [];
            this.wallets = {};
            this.path = chainType === "ngy" /* NordicEnergy */ ? utils.HDPath : "m/44'/60'/0'/0/";
            this.index = index;
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/ , this.messenger.send('ngy_getTransactionCount', [from, 'latest'], 'ngy', this.shardID)];
                        case 1:
                            ...
                            tx = new transaction.Transaction(__assign(__assign({}, txParams), {
                                from: from,
                                to: to,
                                gasLimit: gasLimit,
                                gasPrice: gasPrice,
                            ...
                            }), this.messenger, "INITIALIZED" /* INTIALIZED */ );
