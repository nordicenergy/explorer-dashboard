...
var nordicenergy_1 = require("./nordicenergy");
// tslint:disable-next-line: variable-name
function createWeb3(_web3) {
    var _this = this;
    var url = _web3.currentProvider.url;
    var nordicenergy = new nordicenergy_1.NordicEnergy(url, {
    ...
    var blockchain = nordicenergy.blockchain;
    ...
    _web3.eth.accounts.encrypt = function(privateKey, password) {
        return tslib_1.__awaiter(_this, void 0, void 0, function() {
            var newAcc, result;
            return tslib_1.__generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        newAcc = new nordicenergy.Modules.Account(privateKey, nordicenergy.messenger);
    ...
    _web3.eth.accounts.decrypt = function(keystoreJsonV3, password) {
        return tslib_1.__awaiter(_this, void 0, void 0, function() {
            var newAcc, result;
            return tslib_1.__generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        newAcc = new nordicenergy.Modules.Account();
    ...
    _web3.utils = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, _web3.utils), nordicenergy.utils), nordicenergy.crypto);
}
