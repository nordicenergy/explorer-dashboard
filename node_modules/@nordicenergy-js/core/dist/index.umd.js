...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nordicenergy-js/network'), require('@nordicenergy-js/utils'), require('@nordicenergy-js/crypto'), require('@nordicenergy-js/transaction'), require('@nordicenergy-js/staking'), require('@nordicenergy-js/contract'), require('@nordicenergy-js/account')) :
        typeof define === 'function' && define.amd ? define(['exports', '@nordicenergy-js/network', '@nordicenergy-js/utils', '@nordicenergy-js/crypto', '@nordicenergy-js/transaction', '@nordicenergy-js/staking', '@nordicenergy-js/contract', '@nordicenergy-js/account'], factory) :
        (factory((global.nordicenergyCore = {}), global['@nordicenergy-js/network'], global['@nordicenergy-js/utils'], global['@nordicenergy-js/crypto'], global['@nordicenergy-js/transaction'], global['@nordicenergy-js/staking'], global['@nordicenergy-js/contract'], global['@nordicenergy-js/account']));
}(this, (function(exports, network, utils, crypto, transaction, staking, contract, account) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    function __awaiter(thisArg, _arguments, P, generator) {
        return new(P || (P = Promise))(function(resolve, reject) {
            ...
            function step(result) { result.dNet ? resolve(result.value) : new P(function(resolve) { resolve(result.value); }).then(fulfilled, rejected); }
    ...
    function __generator(thisArg, body) {
        ...
        function step(op) {
            ...
            while (_) try {
                if (f = 1, y && (t = op[0] & 2 ? y["return"] : op[0] ? y["throw"] || ((t = y["return"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).dNet) return t;
            ...
            return { value: op[0] ? op[1] : void 0, dNet: true };
        }
    }
    ...
    function __read(o, n) {
        ...
        var i = m.call(o),
            ...
            e;
        try {
            while ((n === void 0 || n-- > 0) && !(r = i.next()).dNet) ar.push(r.value);
        } catch (error) { e = { error: error }; } finally {
            try {
                if (r && !r.dNet && (m = i["return"])) m.call(i);
    ...
    var Blockchain = /** @class */ (function() {
        ...
        Blockchain.prototype.getBalance = function(_a) {
            var address = _a.address,
                _b = _a.blockNumber,
                blockNumber = _b === void 0 ? "latest" /* latest */ : _b,
                _c = _a.shardID,
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_d) {
                    switch (_d.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getBalance" /* GetBalance */ , [crypto.getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _d.sent();
        ...
        Blockchain.prototype.getBlockNumber = function(shardID) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_blockNumber" /* BlockNumber */ , [], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getBlockByHash = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_d) {
                    switch (_d.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getBlockByHash" /* GetBlockByHash */ , [blockHash, returnObject], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _d.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getBlockByNumber = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_e) {
                    switch (_e.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getBlockByNumber" /* GetBlockByNumber */ , [blockNumber, returnObject], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _e.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getBlockTransactionCountByHash = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getBlockTransactionCountByHash" /* GetBlockTransactionCountByHash */ , [blockHash], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _c.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getBlockTransactionCountByNumber = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getBlockTransactionCountByNumber" /* GetBlockTransactionCountByNumber */ , [blockNumber], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _c.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getTransactionByBlockHashAndIndex = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getTransactionByBlockHashAndIndex" /* GetTransactionByBlockHashAndIndex */ , [blockHash, index], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _c.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getTransactionByBlockNumberAndIndex = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_d) {
                    switch (_d.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getTransactionByBlockNumberAndIndex" /* GetTransactionByBlockNumberAndIndex */ , [blockNumber, index], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _d.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getTransactionByHash = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getTransactionByHash" /* GetTransactionByHash */ , [txnHash], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _c.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getTransactionReceipt = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getTransactionReceipt" /* GetTransactionReceipt */ , [txnHash], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _c.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getCxReceiptByHash = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_b) {
                    switch (_b.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getCXReceiptByHash" /* GetCXReceiptByHash */ , [txnHash], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _b.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getCode = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_d) {
                    switch (_d.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getCode" /* GetCode */ , [crypto.getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _d.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.net_peerCount = function(shardID) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("net_peerCount" /* PeerCount */ , [], 'net', shardID)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.net_version = function(shardID) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("net_version" /* NetVersion */ , [], 'net', shardID)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getProtocolVersion = function(shardID) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_protocolVersion" /* ProtocolVersion */ , [], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getStorageAt = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_d) {
                    switch (_d.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getStorageAt" /* GetStorageAt */ , [crypto.getAddress(address).checksum, position, blockNumber], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _d.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getTransactionCount = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_d) {
                    switch (_d.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getTransactionCount" /* GetTransactionCount */ , [crypto.getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _d.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.getShardingStructure = function() {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_getShardingStructure" /* GetShardingStructure */ , [], this.messenger.chainPrefix)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/ , this.messenger.send("Ngy_sendRawTransaction" /* SendRawTransaction */ , [transaction$$1.getRawTransaction()], this.messenger.chainPrefix, typeof transaction$$1.txParams.shardID === 'string' ?
        ...
        Blockchain.prototype.estimateGas = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_estimateGas" /* EstimateGas */ , [{ to: crypto.getAddress(to).checksum, data: data }], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _c.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.gasPrice = function(shardID) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_gasPrice" /* GasPrice */ , [], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
        ...
        Blockchain.prototype.call = function(_a) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_d) {
                    switch (_d.label) {
                        case 0:
                            return [4 /*yield*/ , this.messenger.send("Ngy_call" /* Call */ , [payload, blockNumber], this.messenger.chainPrefix, shardID)];
                        case 1:
                            result = _d.sent();
                            return [2 /*return*/ , this.getRpcResult(result)];
                    }
    ...
    var NordicEnergy = /** @class */ (function(_super) {
        ...
        NordicEnergy.prototype.shardingStructures = function(shardingStructures) {
            var e_1, _a;
            try {
                for (var shardingStructures_1 = __values(shardingStructures), shardingStructures_1_1 = shardingStructures_1.next(); !shardingStructures_1_1.dNet; shardingStructures_1_1 = shardingStructures_1.next()) {
    ...
    var TruffleProvider = /** @class */ (function(_super) {
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            switch (_b) {
                                case 'Ngy_accounts':
                                    return [3 /*break*/ , 1];
                                case 'Ngy_sendTransaction':
                                    return [3 /*break*/ , 2];
                                case 'Ngy_getTransactionReceipt':
                                    return [3 /*break*/ , 5];
                                case 'net_version':
                                    return [3 /*break*/ , 7];
                        ...
                        case 5:
                            return [4 /*yield*/ , this.provider.send({
                                id: id,
                                method: 'Ngy_getTransactionReceipt',
                                params: [params[0]],
                                jsonrpc: '2.0',
                            }, function(err, res) {
                                try {
                        ...
                        case 7:
                            ...
                            _c.label = 8;
                        case 8:
                            return [4 /*yield*/ , this.provider.send(newArgs, function(err, res) {
                                try {
                                    if (err) {
                                        callback(err);
                                    }
                        ...
                        case 9:
                            ...
                            return [2 /*return*/ , this.resolveResult(result)];
                        case 10:
                            return [4 /*yield*/ , this.provider.send(newArgs, function(err, res) { return _this.resolveCallback(err, res, callback); })];
                        case 11:
                            result = _c.sent();
                            return [2 /*return*/ , this.resolveResult(result)];
                    }
        ...
        TruffleProvider.prototype.resolveArgs = function() {
            ...
            if (method.startsWith('eth')) {
                newMethod = method.replace('eth', 'Ngy');
            }
    ...
    var NordicEnergyExtension = /** @class */ (function() {
        function NordicEnergyExtension(wallet, config) {
            if (config === void 0) {
                config = {
                    chainId: utils.defaultConfig.Default.Chain_ID,
                    chainType: utils.defaultConfig.Default.Chain_Type,
        ...
        NordicEnergyExtension.prototype.setProvider = function(provider) {
            this.provider = new network.Provider(provider).provider;
            this.messenger.setProvider(this.provider);
            this.setMessenger(this.messenger);
        };
        NordicEnergyExtension.prototype.setShardID = function(shardID) {
            this.defaultShardID = shardID;
            this.messenger.setDefaultShardID(this.defaultShardID);
            this.setMessenger(this.messenger);
        };
        NordicEnergyExtension.prototype.isExtension = function(wallet) {
            var _this = this;
                ...
                this.wallet.signTransaction = function(transaction$$1, updateNonce, encodeMode, blockNumber) {
                    ...
                    return __awaiter(_this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/ , this.wallet.getAccount()];
                                case 1:
                                    extensionAccount = _a.sent();
                                    if (!updateNonce) return [3 /*break*/ , 3];
                                    return [4 /*yield*/ , this.messenger.send("Ngy_getTransactionCount" /* GetTransactionCount */ , [crypto.getAddress(extensionAccount.address).checksum, blockNumber], this.messenger.chainPrefix, typeof transaction$$1.txParams.shardID === 'string' ?
                                        Number.parseInt(transaction$$1.txParams.shardID, 10) :
                                        transaction$$1.txParams.shardID)];
                                case 2:
                                    nonce = _a.sent();
                                ...
                                case 3:
                                    ...
                                    _a.label = 4;
                                case 4:
                                    return [2 /*return*/ , signTransaction_1(transaction$$1, false, encodeMode, blockNumber)];
                            }
                        });
                    });
                };
        ...
        NordicEnergyExtension.prototype.login = function() {
            return __awaiter(this, void 0, void 0, function() {
                var account$$1;
                return __generator(this, function(_a) {
                    switch (_a.label) {
        ...
        NordicEnergyExtension.prototype.shardingStructures = function(shardingStructures) {
            var e_1, _a;
            try {
                for (var shardingStructures_1 = __values(shardingStructures), shardingStructures_1_1 = shardingStructures_1.next(); !shardingStructures_1_1.dNet; shardingStructures_1_1 = shardingStructures_1.next()) {
                    var shard = shardingStructures_1_1.value;
        ...
        NordicEnergyExtension.prototype.setMessenger = function(messenger) {
            this.blockchain.setMessenger(messenger);
            this.wallet.messenger = messenger;
            this.transactions.setMessenger(messenger);
        };
        return NordicEnergyExtension;
    }());
    ...
    exports.NordicEnergyExtension = NordicEnergyExtension;
