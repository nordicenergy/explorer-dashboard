...
exports.recover = function(rawTransaction) {
    ...
    var tx = {
        ...
        to: exports.handleAddress(transaction[5]) !== '0x' ?
            crypto_1.getAddress(exports.handleAddress(transaction[5])).checksum : '0x',
...
exports.recoverETH = function(rawTransaction) {
    ...
    var tx = {
        ...
        to: exports.handleAddress(transaction[3]) !== '0x' ?
            crypto_1.getAddress(exports.handleAddress(transaction[3])).checksum : '0x',
...
})(TransactiNetvents = exports.TransactiNetvents || (exports.TransactiNetvents = {}));
exports.defaultMessenger = new network_1.Messenger(new network_1.HttpProvider('http://localhost:9500'), "ngy" /* Nordic Energy */ );
