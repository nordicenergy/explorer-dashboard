...
var utils_1 = require("@nordicenergy-js/utils");
...
var TransactionBase = /** @class */ (function() {
    ...
    TransactionBase.normalizeAddress = function(address) {
        if (address === '0x') {
            return '0x';
        } else if (crypto_1.NordicEnergyAddress.isValidChecksum(address) ||
            crypto_1.NordicEnergyAddress.isValidBech32(address) ||
            crypto_1.NordicEnergyAddress.isValidBech32TestNet(address)) {
    ...
    TransactionBase.prototype.emitTransactionHash = function(transactionHash) {
        this.emitter.emit(utils_2.TransactiNetvents.transactionHash, transactionHash);
    };
    TransactionBase.prototype.emitReceipt = function(receipt) {
        this.emitter.emit(utils_2.TransactiNetvents.receipt, receipt);
    };
    TransactionBase.prototype.emitError = function(error) {
        this.emitter.emit(utils_2.TransactiNetvents.error, error);
    };
    TransactionBase.prototype.emitConfirm = function(data) {
        this.emitter.emit(utils_2.TransactiNetvents.confirmation, data);
    };
    TransactionBase.prototype.emitTrack = function(data) {
        this.emitter.emit(utils_2.TransactiNetvents.track, data);
    };
    TransactionBase.prototype.emitCxReceipt = function(receipt) {
        this.emitter.emit(utils_2.TransactiNetvents.cxReceipt, receipt);
    };
    TransactionBase.prototype.emitCxConfirm = function(data) {
        this.emitter.emit(utils_2.TransactiNetvents.cxConfirmation, data);
    };
    TransactionBase.prototype.emitCxTrack = function(data) {
        this.emitter.emit(utils_2.TransactiNetvents.cxTrack, data);
    };
