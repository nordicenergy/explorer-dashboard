...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@NordicEnergy-js/utils'), require('@NordicEnergy-js/crypto'), require('@NordicEnergy-js/network')) :
        typeof define === 'function' && define.amd ? define(['exports', '@NordicEnergy-js/utils', '@NordicEnergy-js/crypto', '@NordicEnergy-js/network'], factory) :
        (factory((global.NordicEnergyTransaction = {}), global['@NordicEnergy-js/utils'], global['@NordicEnergy-js/crypto'], global['@NordicEnergy-js/network']));
}(this, (function(exports, utils, crypto, network) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var recover = function(rawTransaction) {
        ...
        var tx = {
            ...
            to: handleAddress(transaction[5]) !== '0x' ?
                crypto.getAddress(handleAddress(transaction[5])).checksum : '0x',
    ...
    var recoverETH = function(rawTransaction) {
        ...
        var tx = {
            ...
            to: handleAddress(transaction[3]) !== '0x' ?
                crypto.getAddress(handleAddress(transaction[3])).checksum : '0x',
    ...
    (function(TransactiNetvents) {
        TransactiNetvents["transactionHash"] = "transactionHash";
        TransactiNetvents["error"] = "error";
        TransactiNetvents["confirmation"] = "confirmation";
        TransactiNetvents["receipt"] = "receipt";
        TransactiNetvents["track"] = "track";
        TransactiNetvents["cxConfirmation"] = "cxConfirmation";
        TransactiNetvents["cxReceipt"] = "cxReceipt";
        TransactiNetvents["cxTrack"] = "cxTrack";
    })(exports.TransactiNetvents || (exports.TransactiNetvents = {}));
    var defaultMessenger = new network.Messenger(new network.HttpProvider('http://localhost:9500'), "Ngy" /* NordicEnergy */ );
    var RLPSign = function(transaction, prv) {
        var _a = __read(transaction.getRLPUnsigned(), 2),
    ...
    var TransactionBase = /** @class */ (function() {
        ...
        TransactionBase.normalizeAddress = function(address) {
            if (address === '0x') {
                return '0x';
            } else if (crypto.NordicEnergyAddress.isValidChecksum(address) ||
                crypto.NordicEnergyAddress.isValidBech32(address) ||
                crypto.NordicEnergyAddress.isValidBech32TestNet(address)) {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/ , this.messenger.send("Ngy_getTransactionReceipt" /* GetTransactionReceipt */ , txHash, this.messenger.chainType, typeof shardID === 'string' ? Number.parseInt(shardID, 10) : shardID)];
                        case 1:
                            res = _a.sent();
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 14:
                            ...
                            return [2 /*return*/ , this];
                        case 15:
                            return [4 /*yield*/ , this.socketConfirm(txHash, maxAttempts, shardID)];
                        case 16:
                            result = _a.sent();
                    ...
                    p.onData(function(data) {
                        return __awaiter(_this, void 0, void 0, function() {
                            ...
                            return __generator(this, function(_a) {
                                switch (_a.label) {
                                    case 0:
                                        blockNumber = this.messenger.chainPrefix === 'Ngy' ?
        ...
        TransactionBase.prototype.emitTransactionHash = function(transactionHash) {
            this.emitter.emit(exports.TransactiNetvents.transactionHash, transactionHash);
        };
        TransactionBase.prototype.emitReceipt = function(receipt) {
            this.emitter.emit(exports.TransactiNetvents.receipt, receipt);
        };
        TransactionBase.prototype.emitError = function(error) {
            this.emitter.emit(exports.TransactiNetvents.error, error);
        };
        TransactionBase.prototype.emitConfirm = function(data) {
            this.emitter.emit(exports.TransactiNetvents.confirmation, data);
        };
        TransactionBase.prototype.emitTrack = function(data) {
            this.emitter.emit(exports.TransactiNetvents.track, data);
        };
        TransactionBase.prototype.emitCxReceipt = function(receipt) {
            this.emitter.emit(exports.TransactiNetvents.cxReceipt, receipt);
        };
        TransactionBase.prototype.emitCxConfirm = function(data) {
            this.emitter.emit(exports.TransactiNetvents.cxConfirmation, data);
        };
        TransactionBase.prototype.emitCxTrack = function(data) {
            this.emitter.emit(exports.TransactiNetvents.cxTrack, data);
        };
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/ , this.messenger.send("Ngy_blockNumber" /* BlockNumber */ , [], this.messenger.chainPrefix, typeof shardID === 'string' ? Number.parseInt(shardID, 10) : shardID)];
                        case 1:
                            currentBlock = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/ , this.messenger.send("Ngy_getBlockByNumber" /* GetBlockByNumber */ , [blockNumber, true], this.messenger.chainPrefix, typeof this.shardID === 'string' ? Number.parseInt(this.shardID, 10) : this.shardID)];
                        case 1:
                            block = _a.sent();
                            if (block.isError()) {
                                throw block.message;
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 14:
                            ...
                            return [2 /*return*/ , this];
                        case 15:
                            return [4 /*yield*/ , this.socketCxConfirm(txHash, maxAttempts, toShardID)];
                        case 16:
                            result = _a.sent();
                            return [2 /*return*/ , result];
                        case 17:
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/ , this.messenger.send("Ngy_getCXReceiptByHash" /* GetCXReceiptByHash */ , txHash, this.messenger.chainPrefix, typeof toShardID === 'string' ? Number.parseInt(toShardID, 10) : toShardID)];
                        case 1:
                            res = _a.sent();
    ...
    var Transaction = /** @class */ (function(_super) {
        ...
        function Transaction(params, messenger, txStatus) {
            ...
            _this.cxStatus = _this.isCrossShard() ? "INITIALIZED" /* INTIALIZED */ : "NNet" /* NNet */ ;
            return _this;
        }
        Transaction.prototype.getRLPUnsigned = function() {
            ...
            var fields = this.messenger.chainType === "Ngy" /* NordicEnergy */ ? transactionFields : transactionFieldsETH;
        ...
        Transaction.prototype.getRLPSigned = function(raw, signature) {
            // temp setting to be compatible with eth
            var rawLength = this.messenger.chainType === "Ngy" /* NordicEnergy */ ? 11 : 9;
        ...
        Transaction.prototype.recover = function(rawTransaction) {
            // temp setting to be compatible with eth
            var recovered = this.messenger.chainType === "Ngy" /* NordicEnergy */ ?
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/ , this.messenger.send("Ngy_sendRawTransaction" /* SendRawTransaction */ , this.rawTransaction, this.messenger.chainType, typeof this.shardID === 'string' ? Number.parseInt(this.shardID, 10) : this.shardID)];
                        case 1:
                            res = _a.sent();
        ...
        Transaction.prototype.confirm = function(txHash, maxAttempts, interval, shardID, toShardID) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.txConfirm(txHash, maxAttempts, interval, shardID)];
                        case 1:
                            txConfirmed = _a.sent();
    ...
    var ShardingTransaction = /** @class */ (function(_super) {
        ...
        function ShardingTransaction(params, messenger, txStatus) {
            ...
            var toShardID = toExtraction[1] !== undefined ?
                ...
                params.toShardID :
                0;
            var reParams = __assign(__assign({}, params), {
                from: from,
                to: to,
                shardID: shardID,
                toShardID: toShardID
