import { Transaction } from '@nordicenergy-js/transaction/src/transaction';
import { RLPSign } from '@nordicenergy-js/transaction/src/utils';
import { TxStatus } from '@nordicenergy-js/transaction/src/types';
import { HttpProvider, Messenger } from '@nordicenergy-js/transaction/test/node_modules/@nordicenergy-js/network';
import { isAddress, ChainType, hexToBN, ChainID, isValidAddress } from '@nordicenergy-js/transaction/test/node_modules/@nordicenergy-js/utils';
import { getAddressFromPrivateKey, getAddress } from '@nordicenergy-js/transaction/test/node_modules/@nordicenergy-js/crypto';

import txnVectors from '@nordicenergy-js/transaction/test/transactions.fixture.json';
import reTxnVectors from '@nordicenergy-js/transaction/test/transactions.remake.fixture.json';
import { TransactionFactory } from '@nordicenergy-js/transaction/src';
...
describe('test sign tranction', () => {
  ...
  it('should test sign transaction with NordicEnergy settings', () => {
  ...
  it('should test recover from NordicEnergySignedTransaction', () => {
    const NgyMessenger = new Messenger(provider, ChainType.NordicEnergy, ChainID.Default);
    // tslint:disable-next-line: prefer-for-of
    for (let i = 0; i < reTxnVectors.length; i += 1) {
