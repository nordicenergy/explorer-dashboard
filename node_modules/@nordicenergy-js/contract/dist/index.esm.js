...
import { BN, throwError, INVALID_ARGUMENT, arrayify, hexlify, padZeros, concat, toChecksumAddress, checkArgumentCount, checkNormalize, checkNew, bytesPadRight, keccak256, getAddress, isHexString } from '@nordicenergy-js/crypto';
import { hexToBN, defineReadOnly, isObject, isArray, hexToNumber, numberToHex, isString, isAddress } from '@nordicenergy-js/utils';
import { TransactionFactory } from '@nordicenergy-js/transaction';
import { getResultForData, LogSub } from '@nordicenergy-js/network';
...
var ContractMethod = /** @class */ (function() {
            ...
            return __generator(this, function(_e) {
                switch (_e.label) {
                    ...
                    case 6:
                        ...
                        this.transaction = this.transaction.map(function(tx) {
                            return __assign(__assign(__assign({}, tx), options), { from: from_1 || tx.from, gasPrice: options ? options.gasPrice : tx.gasPrice, gasLimit: gasLimit_1 || tx.gasLimit, nonce: Number.parseInt(hexToNumber(nonce_1), 10) });
                        });
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/ , 4];
                    case 2:
                        return [4 /*yield*/ , this.wallet.signTransaction(this.transaction, updateNonce, 'rlp', 'latest')];
                    case 3:
                        _a = _b.sent();
                        _b.label = 4;
                    case 4:
    ...
    ContractMethod.prototype.createTransaction = function() {
        if (this.wallet.messenger) {
            ...
            var txObject = __assign(__assign({}, this.params[0]), { to: this.contract.address === '0x' ? '0x' : getAddress(this.contract.address).checksum, data: this.encodeABI() });
            // tslint:disable-line
