...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@NordicEnergy-js/crypto'), require('@NordicEnergy-js/utils'), require('@NordicEnergy-js/transaction'), require('@NordicEnergy-js/network'), require('@NordicEnergy-js/account')) :
    typeof define === 'function' && define.amd ? define(['exports', '@NordicEnergy-js/crypto', '@NordicEnergy-js/utils', '@NordicEnergy-js/transaction', '@NordicEnergy-js/network', '@NordicEnergy-js/account'], factory) :
    (factory((global.NordicEnergyContract = {}),global['@NordicEnergy-js/crypto'],global['@NordicEnergy-js/utils'],global['@NordicEnergy-js/transaction'],global['@NordicEnergy-js/network'],global['@NordicEnergy-js/account']));
    ...
    ***************************************************************************** */
        ...
        function step(op) {
            ...
            while (_) try {
                ...
                switch (op[0]) {
                    ...
                    case 4: _.label++; return { value: op[1], dNet: false };
            ...
            if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, dNet: true };
        }
    }
    ...
    var NegativeNet = new crypto.BN(-1);
    var Net = new crypto.BN(1);
    ...
    function getTupleParamCoder(coerceFunc, compNetnts, localName) {
        if (!compNetnts) {
            compNetnts = [];
        }
        var coders = [];
        compNetnts.forEach(function (compNetnt) {
    ...
    var flattenTypes = function (includeTuple, puts) {
        ...
        puts.forEach(function (param) {
            if (typeof param.compNetnts === 'object') {
                ...
                var result = flattenTypes(includeTuple, param.compNetnts);
    ...
    var ContractMethod = /** @class */ (function () {
        ...
        ContractMethod.prototype.send = function (params) {
            ...
            try {
                this.transaction = this.transaction.map(function (tx) {
                    return __assign(__assign({}, tx), params);
                });
                var updateNonce = params.nonce !== undefined ? false : true;
                this.signTransaction(updateNonce).then(function (signed) {
        ...
        ContractMethod.prototype.call = function (options, blockNumber) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var shardID, nonce_1, _a, _b, gasLimit_1, _c, from_1, keys, txPayload, sendPayload, keys_1, keys_1_1, key, result, error_1;
                var e_1, _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            if (!(this.wallet.signer || (options !== undefined && options.from))) return [3 /*break*/, 2];
                            _b = network.getResultForData;
                            return [4 /*yield*/, this.wallet.messenger.send("Ngy_getTransactionCount" /* GetTransactionCount */, [this.wallet.signer ? this.wallet.signer.address : options.from, blockNumber], shardID)];
                        case 1:
                        ...
                        case 5:
                            gasLimit_1 = _c.apply(void 0, [_e.sent()]);
                            _e.label = 6;
                        case 6:
                            // tslint:disable-next-line: prefer-conditional-expression
                            ...
                            this.transaction = this.transaction.map(function (tx) {
                                return __assign(__assign(__assign({}, tx), options), { from: from_1 || tx.from, gasPrice: options ? options.gasPrice : tx.gasPrice, gasLimit: gasLimit_1 || tx.gasLimit, nonce: Number.parseInt(utils.hexToNumber(nonce_1), 10) });
                            });
                            keys = Object.keys(this.transaction.txPayload);
                            txPayload = this.transaction.txPayload;
                            sendPayload = {};
                            try {
                                for (keys_1 = __values(keys), keys_1_1 = keys_1.next(); !keys_1_1.dNet; keys_1_1 = keys_1.next()) {
                                    key = keys_1_1.value;
                                ...
                                try {
                                    if (keys_1_1 && !keys_1_1.dNet && (_d = keys_1.return)) _d.call(keys_1);
                                }
                                finally { if (e_1) throw e_1.error; }
                            }
                            // tslint:disable-line
                            return [4 /*yield*/, this.wallet.messenger.send("Ngy_call" /* Call */, [sendPayload, blockNumber], 
                                // tslint:disable-line
        ...
        ContractMethod.prototype.estimateGas = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            // tslint:disable-line
                            return [4 /*yield*/, this.wallet.messenger.send("Ngy_estimateGas" /* EstimateGas */, [
                                    {
        ...
        ContractMethod.prototype.createTransaction = function () {
            if (this.wallet.messenger) {
                ...
                var txObject = __assign(__assign({}, this.params[0]), { to: this.contract.address === '0x' ? '0x' : crypto.getAddress(this.contract.address).checksum, data: this.encodeABI() });
                // tslint:disable-line
