...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nordicenergy-js/utils'), require('mitt'), require('cross-fetch'), require('websocket')) :
        typeof define === 'function' && define.amd ? define(['exports', '@nordicenergy-js/utils', 'mitt', 'cross-fetch', 'websocket'], factory) :
        (factory((global.nordicenergyNetwork = {}), global['@nordicenergy-js/utils'], global.mitt, global['cross-fetch'], global.websocket));
}(this, (function(exports, utils, mitt, fetch, websocket) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var BaseProvider = /** @class */ (function() {
        ...
        BaseProvider.prototype.getMiddleware = function(method) {
            ...
            var responses = [];
            try {
                for (var _c = __values(this.reqMiddleware.entries()), _d = _c.next(); !_d.dNet; _d = _c.next()) {
                ...
                try {
                    if (_d && !_d.dNet && (_a = _c.return)) _a.call(_c);
                } finally { if (e_1) throw e_1.error; }
            }
            try {
                for (var _f = __values(this.resMiddleware.entries()), _g = _f.next(); !_g.dNet; _g = _f.next()) {
                ...
                try {
                    if (_g && !_g.dNet && (_b = _f.return)) _b.call(_f);
    ...
    var BaseSocket = /** @class */ (function(_super) {
        ...
        BaseSocket.prototype.Netrror = function(error) {
    ...
    var fetchRPC = {
        requestHandler: function(request, headers) {
            return fetch(request.url, {
                ...
                headers: __assign(__assign({}, headers), (request.options && request.options.headers ?
    ...
    var performRPC = function(request, handler, fetcher) {
        return __awaiter(void 0, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/ , _fetch(fetcher.requestHandler(request, DEFAULT_HEADERS), request.options && request.options.timeout ?
    ...
    var HttpProvider = /** @class */ (function(_super) {
        ...
        HttpProvider.prototype.requestFunc = function(_a) {
            ...
            var _b = __read(this.getMiddleware(payload.method), 2),
                tReq = _b[0],
                tRes = _b[1];
    ...
    var WSProvider = /** @class */ (function(_super) {
        ...
        WSProvider.prototype.Netrror = function(event) {
            if (event.code === 'ECONNREFUSED') {
                this.reconnect();
                return;
            }
            _super.prototype.Netrror.call(this, event);
        };
        ...
        WSProvider.prototype.send = function(payload) {
            var _this = this;
            var _a = __read(this.getMiddleware(payload.method), 2),
                tReq = _a[0],
                tRes = _a[1];
        ...
        WSProvider.prototype.subscribe = function(payload) {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.send(payload)];
                        case 1:
                            response = _a.sent();
                ...
                return __generator(this, function(_a) {
                    ...
                    if (this.hasSubscription(subscriptionId)) {
                        return [2 /*return*/ , this.send(payload).then(function(response) {
                            if (response) {
                                _this.removeEventListener(_this.getSubscriptiNetvent(subscriptionId));
                ...
                return __generator(this, function(_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            if (!!subscriptionKeys_1_1.dNet) return [3 /*break*/ , 5];
                        ...
                        case 7:
                            try {
                                if (subscriptionKeys_1_1 && !subscriptionKeys_1_1.dNet && (_a = subscriptionKeys_1.return)) _a.call(subscriptionKeys_1);
                            } finally { if (e_1) throw e_1.error; }
                            return [7 /*endfinally*/ ];
                        case 8:
        ...
        WSProvider.prototype.getSubscriptiNetvent = function(subscriptionId) {
            var _this = this;
    ...
    var Emitter = /** @class */ (function() {
        ...
        Emitter.prototype.Netrror = function(error) {
    ...
    var ResponseMiddleware = /** @class */ (function() {
        ...
        Object.defineProperty(ResponseMiddleware.prototype, "getResult", {
            get: function() {
                return utils.isObject(this.result) ?
                    __assign(__assign({}, this.result), { responseType: 'result' }) : this.result;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(ResponseMiddleware.prototype, "getError", {
            get: function() {
                return utils.isObject(this.error) ?
                    __assign(__assign({}, this.error), { responseType: 'error' }) : this.error;
            },
            enumerable: true,
            configurable: true
        });
    ...
    var Messenger = /** @class */ (function(_super) {
        ...
        Messenger.prototype.setShardingProviders = function() {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_b) {
                    switch (_b.label) {
                        case 0:
                            if (this.chainPrefix !== "Ngy" /* NordicEnergy */ ) {
                                return [2 /*return*/ ];
                            }
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/ , this.send("Ngy_getShardingStructure" /* GetShardingStructure */ , [], this.chainPrefix)];
                        case 2:
                            response = _b.sent();
                            if (response.result) {
                                shardingStructures = response.result;
                                try {
                                    for (shardingStructures_1 = __values(shardingStructures), shardingStructures_1_1 = shardingStructures_1.next(); !shardingStructures_1_1.dNet; shardingStructures_1_1 = shardingStructures_1.next()) {
        ...
        Messenger.prototype.getCurrentShardID = function() {
            var e_3, _a;
            try {
                for (var _b = __values(this.shardProviders), _c = _b.next(); !_c.dNet; _c = _b.next()) {
                    var shard = _c.value;
                ...
                try {
                    if (_c && !_c.dNet && (_a = _b.return)) _a.call(_b);
    ...
    (function(RPCMethod) {
        // 1. Ngy_getBlockByHash
        RPCMethod["GetBlockByHash"] = "Ngy_getBlockByHash";
        // 2. Ngy_getBlockByNumber
        RPCMethod["GetBlockByNumber"] = "Ngy_getBlockByNumber";
        // 3. Ngy_getBlockTransactionCountByHash
        RPCMethod["GetBlockTransactionCountByHash"] = "Ngy_getBlockTransactionCountByHash";
        // 4. Ngy_getBlockTransactionCountByNumber
        RPCMethod["GetBlockTransactionCountByNumber"] = "Ngy_getBlockTransactionCountByNumber";
        // 5. Ngy_getCode
        RPCMethod["GetCode"] = "Ngy_getCode";
        // 6. Ngy_getTransactionByBlockHashAndIndex
        RPCMethod["GetTransactionByBlockHashAndIndex"] = "Ngy_getTransactionByBlockHashAndIndex";
        // 7. Ngy_getTransactionByBlockNumberAndIndex
        RPCMethod["GetTransactionByBlockNumberAndIndex"] = "Ngy_getTransactionByBlockNumberAndIndex";
        // 8. Ngy_getTransactionByHash
        RPCMethod["GetTransactionByHash"] = "Ngy_getTransactionByHash";
        RPCMethod["GetTransactionReceipt"] = "Ngy_getTransactionReceipt";
        RPCMethod["GetCXReceiptByHash"] = "Ngy_getCXReceiptByHash";
        // 9. Ngy_syncing
        RPCMethod["Syncing"] = "Ngy_syncing";
        // 10. net_peerCount
        RPCMethod["PeerCount"] = "net_peerCount";
        // 11. Ngy_getBalance
        RPCMethod["GetBalance"] = "Ngy_getBalance";
        // 12. Ngy_getStorageAt
        RPCMethod["GetStorageAt"] = "Ngy_getStorageAt";
        // 13. Ngy_getTransactionCount
        RPCMethod["GetTransactionCount"] = "Ngy_getTransactionCount";
        // 14. Ngy_sendTransaction
        RPCMethod["SendTransaction"] = "Ngy_sendTransaction";
        // 15. Ngy_sendRawTransaction
        RPCMethod["SendRawTransaction"] = "Ngy_sendRawTransaction";
        // 16. Ngy_subscribe
        RPCMethod["Subscribe"] = "Ngy_subscribe";
        // 17. Ngy_getlogs
        RPCMethod["GetPastLogs"] = "Ngy_getLogs";
        // 18. Ngy_getWork
        RPCMethod["GetWork"] = "Ngy_getWork";
        // 19. Ngy_submitWork
        // SubmitWork = 'Ngy_submitWork',
        // 20. Ngy_getProof
        RPCMethod["GetProof"] = "Ngy_getProof";
        // 21, Ngy_getFilterChanges
        RPCMethod["GetFilterChanges"] = "Ngy_getFilterChanges";
        // 22. Ngy_newPendingTransactionFilter
        RPCMethod["NewPendingTransactionFilter"] = "Ngy_newPendingTransactionFilter";
        // 23. Ngy_newBlockFilter
        RPCMethod["NewBlockFilter"] = "Ngy_newBlockFilter";
        // 24. Ngy_newFilter
        RPCMethod["NewFilter"] = "Ngy_newFilter";
        // 25. Ngy_call
        RPCMethod["Call"] = "Ngy_call";
        // 26. Ngy_estimateGas
        RPCMethod["EstimateGas"] = "Ngy_estimateGas";
        // 27. Ngy_gasPrice
        RPCMethod["GasPrice"] = "Ngy_gasPrice";
        // 28. Ngy_blockNumber
        RPCMethod["BlockNumber"] = "Ngy_blockNumber";
        // 29. Ngy_unsubscribe
        RPCMethod["UnSubscribe"] = "Ngy_unsubscribe";
        // 30. net_version
        RPCMethod["NetVersion"] = "net_version";
        // 31. Ngy_protocolVersion
        RPCMethod["ProtocolVersion"] = "Ngy_protocolVersion";
        // 32. Ngy_getShardingStructure
        RPCMethod["GetShardingStructure"] = "Ngy_getShardingStructure";
        // 33. Ngy_sendRawStakingTransaction
        RPCMethod["SendRawStakingTransaction"] = "Ngy_sendRawStakingTransaction";
        ...
        PollingBlockTracker.prototype._updateLatestBlock = function() {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this._fetchLatestBlock()];
                        case 1:
                            latestBlock = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/ , this.messenger.send("Ngy_blockNumber" /* BlockNumber */ , [])];
                        case 1:
                            result = _a.sent();
                            if (result.isError()) {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/ , this.messenger.subscribe("Ngy_subscribe" /* Subscribe */ , [
                                'newHeads',
                            ])];
                        case 3:
                            subs = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function() {
                return __generator(this, function(_a) {
                    if (this.subscriptionId != null) {
                        this.messenger.unsubscribe("Ngy_unsubscribe" /* UnSubscribe */ , [this.subscriptionId]);
    ...
    var SubscriptionMethod = /** @class */ (function(_super) {
        ...
        SubscriptionMethod.prototype.start = function() {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            subscribePayload = this.constructPayload("Ngy_subscribe" /* Subscribe */ , this.param, this.options);
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
        ...
        SubscriptionMethod.prototype.unsubscribe = function() {
            var unsubscribePayload = this.constructPayload("Ngy_unsubscribe" /* UnSubscribe */ , this.subscriptionId);
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/ , this.messenger.send("Ngy_getLogs" /* GetPastLogs */ , __spread(this.options), this.messenger.chainType, this.shardID)];
                        case 2:
                            getPastLogs = _a.sent();
