...
var BaseProvider = /** @class */ (function () {
    ...
    BaseProvider.prototype.getMiddleware = function (method) {
        ...
        var responses = [];
        try {
            for (var _c = tslib_1.__values(this.reqMiddleware.entries()), _d = _c.next(); !_d.dNet; _d = _c.next()) {
        ...
        try {
            for (var _f = tslib_1.__values(this.resMiddleware.entries()), _g = _f.next(); !_g.dNet; _g = _f.next()) {
