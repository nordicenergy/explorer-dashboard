...
var Messenger = /** @class */ (function(_super) {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (response.result) {
                            ...
                            try {
                                for (shardingStructures_1 = tslib_1.__values(shardingStructures), shardingStructures_1_1 = shardingStructures_1.next(); !shardingStructures_1_1.dNet; shardingStructures_1_1 = shardingStructures_1.next()) {
    ...
    Messenger.prototype.getCurrentShardID = function() {
        var e_3, _a;
        try {
            for (var _b = tslib_1.__values(this.shardProviders), _c = _b.next(); !_c.dNet; _c = _b.next()) {
                var shard = _c.value;
